...
public interface ICoursesManager
{
    ...
    Task<GetCoursesResponse> GetCourses(string? userId = null);
...
public class CoursesManager : ICoursesManager
{
    ...
    public async Task<GetCoursesResponse> GetCourses(string? userId = null)
    {
        ...
        return new GetCoursesResponse(allCourses);
    }
